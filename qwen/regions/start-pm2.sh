...
# Region Worker PM2 Startup Script
...
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}   Region Worker PM2 Startup${NC}"
echo -e "${BLUE}========================================${NC}"
...
echo -e "${YELLOW}Stopping any existing region-worker instances...${NC}"
pm2 delete region-worker 2>/dev/null || true
...
echo -e "${BLUE}========================================${NC}"
echo -e "Monitor logs:     ${GREEN}pm2 logs region-worker${NC}"
echo -e "Monitor status:   ${GREEN}pm2 monit${NC}"
echo -e "Stop workers:     ${GREEN}pm2 stop region-worker${NC}"
echo -e "Delete workers:   ${GREEN}pm2 delete region-worker${NC}"
